						...
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('toko/proses_ubah') ?>" id="form-tambah" method="POST">
									...
									<div class="form-group">
										<label for="nama_toko"><strong>Alamat Email : </strong></label>
										<input type="text" name="alamat_email" id="alamat_email" value="<?= $toko->alamat_email ?>" placeholder="Masukan Nama Pemilik" class="form-control" readonly>
									</div>
									<div class="form-group">
	...
	<script>
		$(document).ready(function(){
			$('#ubah').on('click', function(){
				...
				$('#alamat_email').prop('readonly', false)
			...
			$('button[type="reset"]').on('click', function(){
				...
				$('#alamat_email').prop('readonly', true)
